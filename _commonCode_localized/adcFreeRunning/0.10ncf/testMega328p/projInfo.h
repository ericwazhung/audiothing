...
#include <inttypes.h>
 ...
 const uint8_t __attribute__ ((progmem)) \
   header[] = "polled_uat_TesttestMega328p 2014-12-20 19:53:39";
#else //projInfo Not Shortened nor overridden
 const uint8_t __attribute__ ((progmem)) \
   header0[] = " /home/meh/_commonCode/adcFreeRunning/0.10ncf/testMega328p ";
 const uint8_t __attribute__ ((progmem)) \
   header1[] = " Sat Dec 20 19:53:39 PST 2014 ";
 const uint8_t __attribute__ ((progmem)) \
   headerOpt[] = "  ";
#endif
 ...
 * /home/meh/_avrProjects/audioThing/65-reverifyingUnderTestUser/_commonCode_localized/adcFreeRunning/0.10ncf/testMega328p/projInfo.h
 *
