...
#include <inttypes.h>
 ...
 const uint8_t __attribute__ ((progmem)) \
   header[] = "polled_uart_TesttestMega328p 2014-12-15 17:24:54";
#else //projInfo Not Shortened nor overridden
 const uint8_t __attribute__ ((progmem)) \
   header0[] = " /home/meh/_commonCode/usart_spi/0.10ncf/testMega328p ";
 const uint8_t __attribute__ ((progmem)) \
   header1[] = " Mon Dec 15 17:24:54 PST 2014 ";
 const uint8_t __attribute__ ((progmem)) \
   headerOpt[] = "  ";
#endif
 ...
 * /home/meh/_avrProjects/audioThing/65-reverifyingUnderTestUser/_commonCode_localized/usart_spi/0.10ncf/testMega328p/projInfo.h
 *
