...
#include <inttypes.h>
 ...
 const uint8_t __attribute__ ((progmem)) \
   header[] = "puarTesttestMega328p 2014-12-17 12:51:37";
#else //projInfo Not Shortened nor overridden
 const uint8_t __attribute__ ((progmem)) \
   header0[] = " /home/meh/_commonCode/polled_uar/0.50/testMega328p ";
 const uint8_t __attribute__ ((progmem)) \
   header1[] = " Wed Dec 17 12:51:37 PST 2014 ";
 const uint8_t __attribute__ ((progmem)) \
   headerOpt[] = "  ";
#endif
 ...
 * /home/meh/_avrProjects/audioThing/65-reverifyingUnderTestUser/_commonCode_localized/polled_uar/0.50/testMega328p/projInfo.h
 *
