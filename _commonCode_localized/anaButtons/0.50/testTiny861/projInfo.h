...
#include <inttypes.h>
 ...
 const uint8_t __attribute__ ((progmem)) \
   header[] = "anaButtonsTesttestTiny861 2014-05-03 23:47:49";
#else //projInfo Not Shortened nor overridden
 const uint8_t __attribute__ ((progmem)) \
   header0[] = " /Users/meh/_commonCode/anaButtons/0.50/testTiny861 ";
 const uint8_t __attribute__ ((progmem)) \
   header1[] = " Sat May  3 23:47:49 PDT 2014 ";
 const uint8_t __attribute__ ((progmem)) \
   headerOpt[] = "  ";
#endif
 ...
 * /home/meh/_avrProjects/audioThing/65-reverifyingUnderTestUser/_commonCode_localized/anaButtons/0.50/testTiny861/projInfo.h
 *
