...
#include <inttypes.h>
 ...
 const uint8_t __attribute__ ((progmem)) \
   header[] = "anaButtonsTesttestPWM161 2014-05-11 14:07:49";
#else //projInfo Not Shortened nor overridden
 const uint8_t __attribute__ ((progmem)) \
   header0[] = " /Users/meh/_commonCode/anaButtons/0.50/testPWM161 ";
 const uint8_t __attribute__ ((progmem)) \
   header1[] = " Sun May 11 14:07:49 PDT 2014 ";
 const uint8_t __attribute__ ((progmem)) \
   headerOpt[] = "  ";
#endif
 ...
 * /home/meh/_avrProjects/audioThing/65-reverifyingUnderTestUser/_commonCode_localized/anaButtons/0.50/testPWM161/projInfo.h
 *
